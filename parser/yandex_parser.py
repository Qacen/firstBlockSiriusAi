...
def parsing(url):
        ...
        params = {}
        params["цена"] = driver.find_element(By.XPATH,'//*[@id="root"]/div[1]/div[2]/div/div[4]/div/div[1]/div[2]/div[1]/span').text
        params["адрес"] = driver.find_element(By.XPATH,'//*[@id="location"]/div[1]/section/div[1]').text
        count_rooms = driver.find_element(By.XPATH,'//*[@id="root"]/div[1]/div[2]/div/div[4]/div/div[1]/div[2]/div[1]/h1').text
